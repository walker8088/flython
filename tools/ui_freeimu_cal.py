...
class Ui_FreeIMUCal(object):
    def setupUi(self, FreeIMUCal):
        ...
        self.remoteIPEdit = QtGui.QLineEdit(self.gridLayoutWidget)
        self.remoteIPEdit.setObjectName(_fromUtf8("remoteIPEdit"))
        self.gridLayout.addWidget(self.remoteIPEdit, 0, 1, 1, 1)
